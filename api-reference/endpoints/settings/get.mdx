...
<ResponseField name="data" type="object">
  <Expandable title="Properties">
    ...
    <ResponseField name="invoice_series" type="array">
      List of all configured invoice series
      
      <Expandable title="Series Object">
        <ResponseField name="id" type="string">
          Series ID (use this for series_id parameter)
        </ResponseField>
    ...
    <ResponseField name="primary_series" type="object">
      Primary series for each document type (for quick access)
      
      <Expandable title="Primary Series">
        <ResponseField name="fiscal" type="object">
          Primary fiscal invoice series (same structure as Series Object above)
        </ResponseField>
        
        <ResponseField name="proforma" type="object">
          Primary proforma invoice series (same structure as Series Object above)
        </ResponseField>
      </Expandable>
    </ResponseField>
