...
<ParamField query="expand[]" type="array">
  Expand additional nested objects. See [Expanding Objects](/concepts/expanding-objects) for details.
...
Invoices can be in various states throughout their lifecycle. For a complete understanding of invoice states and transitions, see [Invoice Lifecycle](/concepts/invoice-lifecycle).
...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Invoice Object">
    ...
    <ResponseField name="status" type="string">
      ...
      - `issued` - Invoice issued but not paid
      - `paid` - Invoice fully paid
      - `overdue` - Invoice past due date
      - `voided` - Invoice cancelled/voided (still visible for audit)
    </ResponseField>
    ...
    <ResponseField name="is_paid" type="boolean">
      Payment status - true if fully paid
    </ResponseField>
    
    <ResponseField name="is_draft" type="boolean">
      Draft status - true if invoice is not finalized
    </ResponseField>
    
    <ResponseField name="is_voided" type="boolean">
      Voided status - true if invoice has been cancelled/voided
      
      <Note>
        Voided invoices remain accessible for audit purposes
      </Note>
    </ResponseField>
