...
```bash cURL
curl https://app.contazen.ro/api/v1/invoices/inv_9z8y7x6w5v \
  -H "Authorization: Bearer sk_live_YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch('https://app.contazen.ro/api/v1/invoices/inv_9z8y7x6w5v', {
  headers: {
...
response = requests.get(
    'https://app.contazen.ro/api/v1/invoices/inv_9z8y7x6w5v',
...
```php PHP
$ch = curl_init('https://app.contazen.ro/api/v1/invoices/inv_9z8y7x6w5v');
