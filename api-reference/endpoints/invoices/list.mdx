...
<ParamField query="series_id" type="string">
  Filter by invoice series CzUid
</ParamField>
...
<ParamField query="status" type="string">
  ...
  - `sent` - Sent but unpaid invoices
  - `paid` - Paid invoices
  - `overdue` - Overdue unpaid invoices
  - `cancelled` - Cancelled/voided invoices
</ParamField>
...
curl_setopt($ch, CURLOPT_URL, 'https://api.contazen.ro/v1/invoices?' . $params);
