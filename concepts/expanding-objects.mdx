...
curl https://app.contazen.ro/api/v1/invoices/inv_1a2b3c4d5e \
...
```javascript Node.js
const response = await fetch('https://app.contazen.ro/api/v1/invoices/inv_1a2b3c4d5e?' + 
  new URLSearchParams({
    'expand[]': ['lines', 'client']
  }), {
  headers: {
...
response = requests.get(
    'https://app.contazen.ro/api/v1/invoices/inv_1a2b3c4d5e',
...
curl https://app.contazen.ro/api/v1/invoices/inv_1a2b3c4d5e?expand[]=client&expand[]=lines \
  -H "Authorization: Bearer sk_live_YOUR_API_KEY"
```
...
curl https://app.contazen.ro/api/v1/invoices?expand[]=client \
  -H "Authorization: Bearer sk_live_YOUR_API_KEY"
```
...
curl https://app.contazen.ro/api/v1/invoices/inv_1a2b3c4d5e?expand[]=client&expand[]=invalid_field \
  -H "Authorization: Bearer sk_live_YOUR_API_KEY"
```
